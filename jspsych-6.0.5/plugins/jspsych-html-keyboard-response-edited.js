...
jsPsych.plugins["html-keyboard-response-edited"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var new_html2 = '<div id="jspsych-html-keyboard-response-stimulus">'+trial.stimulus2+'</div>';
    ...
    // draw
    //display_element.appendChild(new_html, new_html2);
