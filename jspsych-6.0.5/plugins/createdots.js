...
jsPsych.plugins["createdots"] = (function() {
	...
	plugin.trial = function(display_element, trial) {
		...
		trial.center_x = assignParameterValue(trial.center_x, window.innerWidth/2);
		trial.center_y = assignParameterValue(trial.center_y, window.innerHeight/2);
	...
	//	var backgroundColor = trial.background_color; //Color of the background
		var apertureCenterX = trial.center_x; // The x-coordinate of center of the aperture on the screen, in pixels
		var apertureCenterY = trial.center_y; // The y-coordinate of center of the aperture on the screen, in pixels
	...
	//	canvas.style.backgroundColor = backgroundColor;
      ...
      var dotArray = dotArray2d[currentSetArray[currentApertureNumber]];
		...
		function draw() {
			...
			//// create the black box behinf the white dots
					ctx.fillStyle = "black";
					ctx.fillRect(apertureCenterX-horizontalAxis, apertureCenterY-verticalAxis,apertureWidth, apertureHeight);
					//(apertureCenterX-horizontalAxis-(borderThickness/2), apertureCenterY-verticalAxis-(borderThickness/2), (horizontalAxis*2)+borderThickness, (verticalAxis*2)+borderThickness);
		    ...
		    if(fixationCross === true){
	      	...
	      	if(border === true){
	          		...
	          		ctx.strokeStyle = borderColor;
							...
							//	ctx.fillRect(apertureCenterX, apertureCenterY,apertureWidth, apertureHeight);
